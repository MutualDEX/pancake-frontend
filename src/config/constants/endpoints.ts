...
export const BITQUERY_API = 'https://graphql.bitquery.io/ide/BigSwap-Pairs' 
 ...
 */
export const INFO_CLIENT = 'https://api.thegraph.com/subgraphs/name/bigswap-finance/bigswap-finance-v2'
